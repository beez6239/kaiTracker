        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalValueUsd = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    TotalTokens = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TotalWallets = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chains_Portfolios_PortfolioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TokenMetadataId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChainId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tokens", x => x.TokenMetadataId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TokenHoldingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TokenHolding", x => x.TokenHoldingId);
                    table.ForeignKey(
                        name: "FK_TokenHolding_Tokens_TokenMetadataId",
                        column: x => x.TokenMetadataId,
                        principalTable: "Tokens",
                        principalColumn: "TokenMetadataId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TokenHolding_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TokenHolding_TokenMetadataId",
                table: "TokenHolding",
                column: "TokenMetadataId");

            migrationBuilder.CreateIndex(
                name: "IX_TokenHolding_WalletId",
                table: "TokenHolding",
                column: "WalletId");
